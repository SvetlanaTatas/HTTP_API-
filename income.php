...
<html>
  ...
  <body>
    ...
    <fieldset>
      ...
      <div class="block_input"><label></label><input type="submit" id="submit" value="Внести"></div>
      <div id="info_a"></div>
    </div>
    <div id="form_update">
    <fieldset>
      ...
      <div class="block_input">
          ...
          <input type="hidden" name="operation" value="more">
  ...
  $('#submit').click(function(){
     $.ajax({
	   url: window.origin +'/api/product/create.php',
	   method: 'post',
	   dataType: 'json',  
	   data: $("#form_socks input[type=\'text\'], #form_socks input[type=\'hidden\']"),
	   success: function(json){ 
	       $("#info_o").html(json['message']);
	       $("#form_socks input[type=\'text\'], #form_socks input[type=\'hidden\']").val('');
	   },
